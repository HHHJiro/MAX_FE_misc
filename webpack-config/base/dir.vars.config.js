...
moduleExports.asstesDir = path.resolve(moduleExports.srcRootDir, './asstes') // 存放各个页面使用到asstes
moduleExports.staticDir = path.resolve(moduleExports.srcRootDir, './static') // 存放各个页面使用到static
...
moduleExports.vendorDir = path.resolve(moduleExports.srcRootDir, './vender') // 存放所有不能用npm管理的第三方库
